  ...
  return (
    <div className={cn(s.customcard)}>
      ...
      <div className={cn(s['customcard__content'])}>
        ...
        <form name='cardForm' id='cardForm' className={cn(s.customcard__box)}>
          <div className={cn(s.customcard__item)}>
            ...
            >
              <option
                className={cn(s.customcard__option)}
                defaultValue={Weight.Primary}
              >
                {Weight.Primary}
              </option>
              <option className={cn(s.customcard__option)}>
                {Weight.Secondary}
              </option>
              <option className={cn(s.customcard__option)}>
                {Weight.Tertiary}
          ...
          <div className={cn(s.customcard__item)}>
            ...
            <select
              ...
              className={cn(s.customcard__item__select)}
            >
              <option className={cn(s.customcard__option)} defaultValue={1}>
                1
              </option>
        ...
        <div className={cn(s.customcard__text)}>
          <span>Цена: </span>
          <span className={cn(s.customcard__cost)}>{price}</span>
