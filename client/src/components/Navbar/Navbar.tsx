        ...
        <nav>
          <ul className={cn(s.nav__links)}>
            <li className={cn(s.nav__item)}>
              {isAuthenticated ? (
                <NavLink to={'/'} className={cn(s.Navbar__icon)}>
                  <svg
                ...
                <NavLink className={cn(s.Navbar__icon)} to={route.LOGIN_ROUTE}>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    fill='none'
                    stroke='currentColor'
            ...
            <li
              className={cn(s.nav__item, {
                [s['nav_item--bascket']]: cartVisible,
              })}
              onMouseEnter={(e) => {
                setCartVisible(true);
              }}
            ...
            >
              <NavLink
                to='/basket'
                className={cn({ [s.Navbar__icon]: true, [s.cart]: true })}
              >
                <span className={s.cart__count}>{cart.getCount()}</span>
                <svg
                  viewBox='0 0 32 32'
                  xmlns='http://www.w3.org/2000/svg'
                  className={cn(s.Navbar__img)}
